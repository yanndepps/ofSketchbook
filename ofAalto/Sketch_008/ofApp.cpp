...
void ofApp::draw()
{
  ...
  for (int i = 0; i < points.size(); i++) {
    float r = 127 + 127 * sin(ofDegToRad(i + 45 * sin(ofDegToRad(selectedFrame))));
    float g = 63 + 127 * sin(ofDegToRad(i + selectedFrame));
    float b = 127 + 127 * sin(ofDegToRad(i + 100 * sin(ofDegToRad(selectedFrame))));
